...
const index_1 = require("../src/lib/db/prisma/index");
...
const events = [
    {
        ...
        description: "A sync meeting for engineers to discuss progress and blockers.",
...
async function seed() {
    ...
    for (const event of events) {
        await index_1.prisma.event.create({
            data: {
                ...event,
                userId,
                status: "PUBLISHED",
